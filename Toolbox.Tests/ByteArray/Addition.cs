...
namespace ByteArray
{
    ...
    public static partial class Addition
    {
        ...
        {
            Assert.Throws<System.ArgumentException>(() => Toolbox.ByteArray.Addition(byteArray1, byteArray2));
        }
        ...
        {
            Assert.Throws<System.ArgumentNullException>(() => Toolbox.ByteArray.Addition(byteArray1, byteArray2));
        }
    }
}
