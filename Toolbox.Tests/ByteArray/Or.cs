...
namespace ByteArray
{
    ...
    public static partial class Or
    {
        ...
        {
            Assert.Throws<System.IndexOutOfRangeException>(() => Toolbox.ByteArray.Or(byteArray1, byteArray2));
        }
        ...
        {
            Assert.Throws<System.ArgumentException>(() => Toolbox.ByteArray.Or(byteArray1, byteArray2));
        }
        ...
        {
            Assert.Throws<System.ArgumentNullException>(() => Toolbox.ByteArray.Or(byteArray1, byteArray2));
        }
    }
}
