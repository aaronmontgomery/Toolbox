...
namespace Network
{
    ...
    public static class SubnetRange
    {
        ...
        {
            Assert.Throws<System.ArgumentException>(() => Toolbox.Network.SubnetRange(subnetIp, subnetMask));
        }
        ...
        {
            Assert.Throws<System.ArgumentNullException>(() => Toolbox.Network.SubnetRange(subnetIp, subnetMask));
        }
    }
}
